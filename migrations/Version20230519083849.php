 ...
 */
final class Version20230519083849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gite (id INT AUTO_INCREMENT NOT NULL, ville_id INT NOT NULL, proprietaire_id INT NOT NULL, contact_id INT NOT NULL, prix_id INT NOT NULL, nom VARCHAR(255) NOT NULL, surface DOUBLE PRECISION NOT NULL, nb_chambres INT NOT NULL, nb_lits INT NOT NULL, accept_animaux TINYINT(1) NOT NULL, tarif_animaux NUMERIC(10, 2) DEFAULT NULL, image LONGTEXT NOT NULL, INDEX IDX_B638C92CA73F0036 (ville_id), INDEX IDX_B638C92C76C50E4A (proprietaire_id), INDEX IDX_B638C92CE7A1254A (contact_id), INDEX IDX_B638C92C944722F2 (prix_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
